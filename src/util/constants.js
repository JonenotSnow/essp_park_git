...
const constants = {
    ...
    // 用户角色
    userRole: {
        tourist: { key: '11', value: '游客' },
        inlineManager: { key: '21', value: '行内客户经理' },
        inlineAdmin: { key: '22', value: '行内管理者' },
        entOperator: { key: '31', value: '注册会员操作员' },
        entAdmin: { key: '32', value: '注册会员管理员' },
        parkPrimaryManager: { key: '33', value: '园区初级管理员' },
        parkAdvancedManager: { key: '34', value: '园区高级管理员' },
        platformPrimaryManager: { key: '41', value: '平台普通管理员' },
        platformAdvancedManager: { key: '42', value: '平台高级管理员' },
        primaryService: { key: '43', value: '普通客服' },
        advancedService: { key: '44', value: '高级客服' },
        contentOperation: { key: '45', value: '内容运营岗' },
        dataAnalysis: { key: '46', value: '数据分析岗' },
        developer: { key: '47', value: '开发操作员' },
        povertyReliefPrimaryManager: { key: '51', value: '扶贫高级管理员' },
        greenProjectManager: { key: '52', value: '绿色项目管理员' },
        reportDemo: { key: '97', value: '汇报演示岗' },
        branchOperationManager: { key: '98', value: '分行运营管理岗' },
        systemManager: { key: '99', value: '系统管理员' }
    },
    // 企业类型
    enterpriseType: {
        churchyardType: { key: '01', value: '境内企业客户' },
        goverType: { key: '02', value: '政府客户' },
        overseasType: { key: '03', value: '境外企业客户' },
        causeType: { key: '04', value: '事业单位客户' },
        peopleNonEntType: { key: '05', value: '其他民办非企业单位客户' },
        bankEntType: { key: '06', value: '银行类客户' }
    },
    // 园区保定数据
    bdParkData: {

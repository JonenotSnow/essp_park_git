            ...
            <div style="height: 76px;">
                ...
                <div class="headmain"
                    ...
                    <div class="auto padding esspclearfix">
                        <div class="logocon">
                            <img v-if="jzfpLogo"
                                 :src="'./static/xq_images/LOGO.png'"
                                 alt=""
                                 class="jzfp-logo">
                            <img v-else
                                 :src="'./static/images/essp_logo.png'"
                                 alt="logo"
                                 @click="tolink();">
                        </div>
...
<script>
    ...
    export default {
        name: "",
        props: ["routerTypeNum", "type", "navBarData", "jzfpLogo", "active", 'isloginFlag'],
        components: {
            EsspNav,
            EsspJzfpNav
        },

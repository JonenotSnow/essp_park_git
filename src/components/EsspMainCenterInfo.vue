<template>
    <div class="essp-main-cont">
        ...
        <essp-mc-card-info :mcCardList="mcCardDataList" :chilrPageType="pageType"></essp-mc-card-info>
...
<script>
    ...
    import EsspMcCardInfo from '@/components/EsspMcCardInfo';
    // 引入获取列表的公共的js
    import {parkInfo} from '@/fetch/api/parkInfo/parkInfo'

<template>
    <div class="essp-card-cont-inner esspclearfix">
        <div class="essp-card" v-for="(item, mcCardIndex) in mcCardList"
             v-if="mcCardList.length>0" :key="mcCardIndex">
            ...
            <div class="cont-detail">
                ...
                <div class="cont-detail-r 123" v-if="LoginUserRol == '11'">
                    <button
                        type="primary" v-if="item.btn.length>0"
                ...
                <div class="cont-detail-r  456" v-else>
                    <button
                        ...
                        v-for="(itemChild,index) in item.btn" :key="index"
                        @click="enrollToPage(itemChild,item,mcCardIndex)"
                    >{{itemChild.name}}
                    </button>
                </div>

export const user = {
    getOtherTokenUrl: '/refreshAuthToken',  // 外链通过token获取信息
    getBrowser: '/behavior/getBrowser',  // 用于后台记录浏览器类型
    getUserTypeUrl: '/selectUserType', // 获取用户类型
    getLoginUrl: '/authToken',  // 登录
    getOtherUrlFirstLogin: '/userLogin/auth',  // 政务云点击跳转来同意用户协议
    getImportFirstLogin: '/usr/auth/userAgreement',  // 批量导入点击跳转来同意用户协议
    ...
    sendNewsToUser: '/news/info/hadoopInfoByUser',  // 资讯触发大数据推送最新资讯给用户，仅用作一个触发器
    ...
    submitCertUrl: '/usr/auth/aply/save2',  // 企业认证
    ...
    getFindMyFocusAncUrl:'/myfocus/findMyFocusAnc', // 获取 关注的资讯列表
    getFindMyFocusgovUrl:'/myfocus/focusClick', // 修改 关注的资讯

    getFocusProduct:'/myfocus/findMyFocusComd',//获取关注的商品
    focusClick:'/myfocus/focusClick',//取消关注商品
    selectedCancelFocus:'/myfocus/selectedCancelFocus', //批量取消关注商品
    ...
    subMessageUrl: '/messageBuyer/findChildMsgsByMsgId', //获取子消息
    //版本灰度
    ...
    getParkList:'/parkManage/getAdminPark',                     //获取园区下拉列表
    getRoleList:'/userPostWeb/selectUserPostParamList',         //获取角色配置信息
    saveRole:'/userPostWeb/insertUserPost',                     //保存角色配置
}

                    ...
                    <div class="actleft">
                        <div>
                            ...
                            <div>
                                ...
                                <p class="actcpname login_con_a" @click="interCc()">
                                    {{actData.cstName ? actData.cstName : "进入企业橱窗>>"}}</p>
                    ...
                    <div class="actright">
                        <div class="maininfo esspclearfix">
                            ...
                            <div class="detailcon">
                                ...
                                <p class="icon_p_font">
                                    <span><i :class="icons[2]" style="color: #ccc"></i>{{actData.viewSum}}</span>
                        ...
                        <el-table-column prop="ticketNum" align="center" label="数量">
                            <template slot-scope="scope">
                                <div class="count esspclearfix">
                                    <!-- 有待优化吧 -->
                                    <div class="esspfl minus"
                                         v-if="scope.row.ticketNum > 0 && scope.row.ticketRemain > 0"
                                    ...
                                    <div class="esspfl plus" @click="plus(scope.$index,scope.row)"
                                         v-if="scope.row.ticketRemain > scope.row.ticketNum ">
                ...
                <div class="enroll_margin">
                                ...
                                <div class="tabmain" v-show="childItem.isShow">
                                    ...
                                    <div class="itemdiv" v-for="(formListItem, formListIndex) in childItem.formRqList"
                                        ...
                                        <el-select v-if="formListItem.type=='radio'" v-model="formListItem.tittext"
                                            ...
                                            <el-option v-for="item in formListItem.childrens" :key="item.name"
                    ...
                    <div v-show="bookstyle == '2'" class="batchimport esspclearfix">
                        ...
                        <div class="batchbtn">
                            ...
                            <el-upload class="uploadbtn upload-demo" action="#" :file-list="listFile"
                    ...
                    <div class="tabmain" style="padding-bottom: 30px;">
                        <div class="itemdiv" v-for="(item,index) in formRqList" :key="index">
                            ...
                            <el-select v-if="item.type=='radio'" v-model="item.tittext" clearable placeholder="请选择">
                                <el-option v-for="item in item.childrens" :key="item.name" :label="item.name"
                                           :value="item.name">
                                </el-option>
                            </el-select>
                            <!--复选框-->
                            <el-select multiple v-if="item.type=='checkbox'" v-model="item.tittext" clearable
                                       placeholder="请选择">
                                <el-option v-for="item in item.childrens" :key="item.name" :label="item.name"
                                           :value="item.name">
                                </el-option>

<template>
    <div class="requestAddPark" id="requestAddPark" v-if="show">
            ...
            <div class="content">
                ...
                <div class="detail" v-if="getFormList && getFormList.length>0">
                    <div v-for="(it,i) in getFormList" :key="i">
                        ...
                        <p v-if="!it.fx && it.type == 'text'"><input type="text" v-model='it.value'
                                                                     :placeholder="`请输入${it.name}`"></p>
                        <p v-else-if="!it.fx && it.type == 'textarea'">
                            <textarea v-model="it.value" :placeholder="`请输入${it.name}`"></textarea>
                        </p>
                        <p v-else-if="!it.fx && ',radio,'.indexOf(','+it.type+',')>-1" class="downSel"
                        ...
                        <p v-else-if="!it.fx && ',checkbox,'.indexOf(','+it.type+',')>-1" class="downSel"
                           style="text-indent:5px;">
                            <el-checkbox-group v-model="it.value">
                                <el-checkbox :label="is.name" v-for="(is,j) in it.childrens"
                                             :key="j"></el-checkbox>
                            </el-checkbox-group>
                        </p>
                        ...
                        <p v-else-if="!it.fx && it.type == 'checkboxDown'" class="downSel"
                           style="text-indent:5px;min-height:35px;">
        ...
        <el-dialog :visible.sync="accessT" width='560px' class='access'>
            ...
            <p class="accessP"><i class="el-icon-warning"></i>&nbsp;&nbsp;是否确认加入该园区</p>
            <p class="btn">
        ...
        <el-dialog :visible.sync="access" width='560px' class='access'>
            <h2 class="titleTips">提示</h2>
            <p class="accessP"><i class="el-icon-warning"></i>&nbsp;&nbsp;是否确认取消加入该园区</p>
            <p class="btn">

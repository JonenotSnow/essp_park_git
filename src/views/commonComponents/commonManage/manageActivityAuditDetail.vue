<template>
    <div class="actauditpage" id="manageParkAuditDetail">
        ...
        <activity-auditing-base-info :titleText="titleText"></activity-auditing-base-info>
        <manage-audit-info></manage-audit-info>
    </div>
</template>

<script>
import EsspBreadCrumb from "@/components/EsspBreadCrumb";
import ManageAuditInfo from "./common/manageAuditInfo";
import ActivityAuditingBaseInfo from "./baseInfo/activityAuditingBaseInfo";
export default {
    components: {
        EsspBreadCrumb,
        ManageAuditInfo,

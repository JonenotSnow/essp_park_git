    ...
    <div id="dataManage">
        ...
        <el-collapse class="accordion">
            <el-collapse-item v-for="(item,i) in list" :key="i">
                <template slot="title" style="font">
                {{item.title}}
                </template>
                <div class="list">
                    <ul v-for="(is,j) in item.content" :key="j" :class="{'top':j>0}">
                        <li>
                            <span class="require"><span>*</span>年份：</span>
                            <el-date-picker
                                v-model="is.time"
                                type="date"
                                placeholder="选择日期"
                        ...
                        <li>
                            <span class="require"><span>*</span>{{is.subTitle}}</span>
                            <div>
                        ...
                        <span class="addYear" v-if="j == item.content.length-1"><i class='el-icon-plus'></i>添加年份</span>
                    </ul>
                </div>
            </el-collapse-item>
        </el-collapse>
...
#dataManage .list ul li:nth-of-type(1) .el-date-editor.el-input, .el-date-editor.el-input__inner{

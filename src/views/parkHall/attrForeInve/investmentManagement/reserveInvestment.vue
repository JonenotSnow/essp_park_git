<template>
    ...
    <div class="main-investcon">
                            ...
                            <div class="detail-tool">
                                <el-dropdown split-button type="primary" @command="handleCommand"
                                    ...
                                    <el-dropdown-menu slot="dropdown">
                                        ...
                                        <el-dropdown-item :command="{items,keyindex:1}">转为在谈</el-dropdown-item>
        ...
        <item-trace-dialog
            :show='detailListDetailShow'
            :detail='detailListDetail'
            @parentShowTrance="parentShowTrance"></item-trace-dialog>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listData: [],//全部数据源头
                //新版接口字段
                followStatus: "0",//商机状态（0：储备，1：在谈，2：已成交，3：搁置）
        ...
        methods: {
            ...
            // 展示详情列表里的详情内容
            showDetail(item) {
                if (item.attractFollow == null) {
                    this.$message.warning('暂无登记');
                    return;
                }

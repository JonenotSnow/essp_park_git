                ...
                <ul class="listconitem" v-if="listData.length">
                    <li class="listdes" v-for="(items,index) in listData" :key="index">
                        ...
                        <div class="list_detail esspclearfix">
                            ...
                            <!--<el-dropdown-item :command="{items,keyindex:0}">转为储备</el-dropdown-item>-->
                            <!--<el-dropdown-item :command="{items,keyindex:1}">删除</el-dropdown-item>-->
                            <!--</el-dropdown-menu>-->
                            <!--</el-dropdown>-->
                            <!--</div>-->
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listData: [],//全部数据源头
                //新版接口字段
                followStatus: "3",//商机状态（0：储备，1：在谈，2：已成交，3：搁置）

<template>
  <div class="inclusivefinance">
    ...
    <div class="inclusive_menu">
      <div class="menulist">
        <div class="listitem" v-for="(item,index) in menuList" :key="index" :class="{cur:item.isCur}" @click="showInclusiveDetail(item,index)">{{item.name}}</div>
      </div>
        ...
        <div class="inclusive_cont_list industry_solutions" :class="{cur:detailShow[2]}"><!--行业解决方案-->
          <div class="iscase_f">
            <div class="iscase_fir">
              <div class="iscase_fir_box" v-for="(item,index) in industrySolutions.slice(0,5)" :key="index" @click="showCaseFirDetail(item,index)">
          ...
          <div class="iscase_s">
            <div class="iscase_sec">
              <div class="iscase_sec_box" v-for="(item,index) in industrySolutions.slice(5,10)" :key="index" @click="showCaseSecDetail(item,index)">
                <i class="iconfont" :class="item.icon"></i>
                <div class="casename">{{item.name}}</div>
                <b class="separate_l">——</b>
                <p class="case_secdec">{{item.secDec}}</p>

    ...
    <div class="el-main">
        <div class='notice'>
            <p><i class="icon iconfont icon-guangbo" style="color: orange;"></i>【小秘书】您有
                <span>{{count.policyCount?count.policyCount:0}}</span>
                条未被领取的惠政发布申请，快来处理吧~</p>
        </div>
        <div class="baseInfo">
            <div class="searchAdd">
                <ul>
                    <li>
                        <div>
                            <span>惠政主题：</span>
                            <input type="text" v-model="searchCondition.title" placeholder="请输入惠政主题">
                        </div>
                        <div>
                            <span>发布人：</span>
                            <input type="text" v-model='searchCondition.publishUser' placeholder="请输入发布人">
                        </div>
                        <div>
                            <span>状态：</span>
            ...
            <div class="tabList">
                <el-table
                    ...
                    <el-table-column show-overflow-tooltip align="center" prop="policyTitle" label="惠政主题" width="200"></el-table-column>
                    ...
                    <el-table-column show-overflow-tooltip align="center" prop="userName" label="发布人"></el-table-column>
    ...
    methods:{
        ...
        getList(){
            var pop = {
                ...
                name : this.searchCondition.publishUser,
        ...
        //校验审核状态
        cancelAudit(row,id){
            if (!this.LoginUserRol.includes('34')) {
                this.$message({
                    type: 'warn',
                    message: '该条资讯已设置为需要园区高级管理员审核'
                });
                return;
            }

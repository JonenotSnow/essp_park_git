            ...
            <div class="base_tablecon">
                ...
                <div class="tdcon esspclearfix">
                    ...
                    <el-select v-model="classtType" placeholder="请选择" class="inline_select">
                        <el-option v-for="(item,index) in typeitems" :key="index" :label="item.name" v-if="index>0"
                ...
                <div class="tdcon">
                    ...
                    <el-input class="inline-textarea" type="textarea" :rows="5" placeholder="请输入内容"
                              v-model="contentbrif"></el-input>
                </div>
                <div class="tdcon">
                    <span class="inline_span">
                        <em>*</em>发布人 :
                    ...
                    <div class="inline-box">
                        <el-input class="pulishinput tdcon_input" style="width:500px" v-model="initiatorWay"
                                  placeholder="反显用户关联名称，不可更改" :readonly="true"></el-input>
                    </div>
                </div>
                <div class="tdcon">
                    <span class="inline_span">
                ...
                <div class="tdcon">
                    ...
                    <div class="inline-box wrap" id="publishNewInfo">
                        ...
                        <vue-ueditor v-model="infoDetail" :ueditorConfig="editorOption"></vue-ueditor>
                    </div>
                </div>
            </div>
        </div>
        ...
        <el-dialog title="资讯发布预览功能（仅提供预览功能）" :visible.sync="infoDialog" width="90%">
            <div class="inlookInfo">
                ...
                <div class="inlookContent">
                    <div class="editor-content" v-html="this.infoDetail"></div>
                </div>
            </div>

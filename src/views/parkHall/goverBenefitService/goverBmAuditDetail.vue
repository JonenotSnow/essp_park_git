    ...
    <div class="personal" v-if="enrollType != '1'">
      ...
      <div class="enroll_margin" style="width: 1200px;margin: 0 auto;">
            ...
            <div class="tablemain_item">
              ...
              <div class="tabmain" v-show="item.isShow">
                ...
                <div class="itemdiv" v-for="(formListItem, formListIndex) in item.formRqList" :key="formListIndex">
                  ...
                  <!--输入框-->
                  <input disabled v-if="formListItem.type=='text'" type="text" :placeholder="'请输入'+formListItem.name" v-model="formListItem.tittext">
                  <!--文本框-->
                  <el-input disabled type="textarea" v-if="formListItem.type=='textarea'" :rows="2" :placeholder="'请输入'+formListItem.name" v-model="formListItem.tittext"></el-input>
                  <!--单选框-->
                  <el-select disabled v-if="formListItem.type=='radio'" v-model="formListItem.tittext" clearable placeholder="请选择">
                    <el-option v-for="(item,index) in formListItem.childrens" :key="item.value" :label="index" :value="item.name">
                    </el-option>
                  </el-select>
                  <!--复选框-->
                  <el-select disabled multiple collapse-tags v-if="formListItem.type=='checkbox'" v-model="formListItem.tittext" clearable placeholder="请选择">
                    <el-option v-for="(item,index) in formListItem.childrens" :key="item.value" :label="index" :value="item.name">
                    </el-option>
                  </el-select>
                  <!--日期模版-->
                  <el-date-picker disabled readonly="true" v-if="formListItem.type=='dataTime'" v-model="formListItem.tittext" type="datetime" placeholder="选择日期时间"></el-date-picker>
                  <!--数字模版-->
                  <el-input disabled readonly="true" v-if="formListItem.type=='numberBox'" v-model="formListItem.tittext" type="number" auto-complete="off" class="cpm"></el-input>
                </div>
                <div class="itemdiv">
        ...
        <div v-show="radio == '2'" style="background: #fff;">
          <div class="esspclearfix" style="position:relative;padding-bottom:30px;width: 1000px;margin: 0 auto;">
            <el-button size="small" style="position: absolute;left: 95px;">下载模板
            </el-button>
            <el-upload class="upload-demo" style="float:left;" action="" multiple :limit="3" :on-exceed="handleExceed" :file-list="fileList">
      ...
      <div class="tablemain">
        <div class="tabmain" style="padding-bottom: 30px;">
          <div class="itemdiv" v-for="(item,index) in formRqList" :key="index">
            ...
            <input v-if="item.type=='text'" type="text" :placeholder="'请输入'+item.name" v-model="item.tittext" readonly="true">
            <!--文本框-->
            <el-input type="textarea" v-if="item.type=='textarea'" :rows="2" :placeholder="'请输入'+item.name" v-model="item.tittext" readonly="true"></el-input>
            <!--单选框-->
            ...
            <!--数字模版-->
            <el-input v-if="item.type=='number'" v-model="item.tittext" type="number" auto-complete="off" class="cpm" readonly="true"></el-input>
          </div>
        </div>
      </div>
    </div>

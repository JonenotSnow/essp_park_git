                ...
                <div class="tabmain" style="padding-bottom: 30px;">
                    <div class="itemdiv" v-for="(item,index) in formRqList" :key="index">
                        ...
                        <el-input type="textarea" v-if="item.type=='textarea'" :rows="2"
                                  :placeholder="'请输入'+item.name" v-model="item.tittext" readonly="true"></el-input>
                        <!--单选框-->
                        ...
                        <el-input v-if="item.type=='number'" v-model="item.tittext" type="number"
                                  auto-complete="off" class="cpm" readonly="true"></el-input>
                    </div>
                </div>
            </div>
        </div>
            ...
            getInfo() {
                this.$post(this.$apiUrl.goverBene.getApplyById, {
                    ...
                    if (response.resultCode == "CLT000000000") {
                        ...
                        this.nrollFormList = JSON.parse(this.infoList.applyInfo);

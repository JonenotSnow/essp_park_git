            ...
            <div class="toolcon esspclearfix">
                ...
                <div class="toolright">
                    <el-button
                        ...
                        type="primary"
                        size="mini"
                        @click="$router.push('/parkIndex/publishGover')"
                    >
            ...
            <ul v-if="type == 0" class="esspclearfix">
                <li class="itemli" v-for="(item, index) in activedata" :key="index">
                    <div class="infostit esspclearfix">
                        <span class="spanfabu">发布人:<em>{{item.userName}}</em></span>
                ...
                <span class="funitems">
                  ...
                  {{item.countFollower || 0}}
                        ...
                        <div class="detailcon detailcon_r essp-card-cont-inner1"
                             v-if="checkActivityOperateAuth(item.userName)">
                            <el-button
                                type="primary"
                                class="essp-btn"
    ...
    export default {
        ...
        methods: {
            ...
            statusCn(startTime, endTime) {
                ...
                if (this.nowTime >= enterStarttime && this.nowTime <= enterEndtime) {
                    this.curstatus = 1;
                    return "发布中";
                }

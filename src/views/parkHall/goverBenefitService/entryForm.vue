                ...
                <div class="newscon">
                    ...
                    <div class="tagscon" v-show="tags.length>0">
                        <div class="tags_con" style="text-align: center">
                            ...
                            <el-tag class="tagitem" v-for="(it, tagIndex) in tags" v-if="tagIndex<3" :key="tagIndex"
                                    size="mini">
                                {{it}}
                            </el-tag>
                        </div>
                ...
                <div class="enroll_margin" style="width: 1200px;margin: 0 auto;">
                            ...
                            <div class="tablemain_item">
                                ...
                                <div class="tabmain" v-show="item.isShow">
                                    <div class="itemdiv" v-for="(formListItem, formListIndex) in item.formRqList"
                                        ...
                                        <!--数字模版-->
                                        <el-input v-if="formListItem.type=='number'" v-model="formListItem.tittext"
                                                  type="number" auto-complete="off" class="cpm"></el-input>
                                    </div>
                                    <div class="itemdiv">
                                        <el-button round class="tablebtn" size="mini"
                                                   @click="item.isShow = !item.isShow ">收起
                                        </el-button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div v-show="bookstyle == '2'" class="batchimport">
                        ...
                        <div class="batchbtn esspclearfix">
                            <el-button size="small" type="primary" class="downloadbtn"><a class="down_a"
                                                                                          :href="activeDetailData.enrolTemplateUrl">下载模板</a>
                            </el-button>
                ...
                this.nrollFormList.forEach((item, index) => {
                    item.forEach((itemChild, indexChild) => {
                        ...
                        for (var key in itemChild) {
                            ...
                            if (val !== 0 && val == "") {
                                isNull = true;
                                this.$message.error("您当前的票种" + itemChild.pName + ",第" + (j + 1) + "项的" + this.getTitleName(key) + "为空！");
                            }
                        }
                    })
                })
            ...
            grSubmit() {
                ...
                if (this.enrollType == "1") {
                    ...
                    if (nums > this.maxNum) {
                        ...
                        this.$message.error("剩余可申报人数" + this.maxNum + "人，请修改申报人数");

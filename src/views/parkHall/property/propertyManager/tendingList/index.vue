           ...
           <!-- <p>采取先到先得的任务领取审核方式</p> -->
            <div class="tabList">
                <el-table
                    ...
                    <el-table-column show-overflow-tooltip align="center" prop="upId" label="计划编号" width="200"></el-table-column>
                    <el-table-column show-overflow-tooltip align="center" prop="planStartTime" label="计划开始时间" width="150"></el-table-column>
                    <el-table-column show-overflow-tooltip align="center" prop="planEndTime" label="计划结束时间" width="150"></el-table-column>
                    <el-table-column show-overflow-tooltip align="center" prop="customName" label="制定人" width="150"></el-table-column>
                    <el-table-column align="center" prop="createTime" label="制定时间" width="150">
                        <template slot-scope="scope">
                            {{scope.row.createTime | timerFormat(scope.row.createTime)}}
                        </template>
                    </el-table-column>
                    <el-table-column show-overflow-tooltip align="center" prop="upkeepItem" label="保养项目" width="150"></el-table-column>
                    ...
                    <el-table-column show-overflow-tooltip align="center" prop="equipmentName" label="设备名称" width="150"></el-table-column>
                     <el-table-column show-overflow-tooltip align="center" prop="planStatus" label="计划状态"></el-table-column>
                    ...
                    <el-table-column align="center" prop="" width="150" label="操作" fixed="right">
                        <template slot-scope="scope">
                            ...
                            <el-button  type="text" @click="deleteItem({upId:scope.row.upId},scope.row.$index)">删除</el-button>
                                </template>
                         </template>
                    </el-table-column>
                </el-table>
...
// import dialogAdd from "../equipmentTending/index";
export default {
  data() {
    return {
      totalCount: 0,
  ...
  methods: {
    ...
    deleteItem(data, index) {
      this.$confirm("是否删除?", "删除").then(() => {
        ...
        this.$post(this.$apiUrl.property.deleteUpkeepPlan, {
          upId: data.upId,
          parkId: this.parkId
        }).then(
          res => {
    ...
    changeTypeWay(item) {
      this.$post(this.$apiUrl.property.getUpkeepPlanPage, {
        id: item.id,
        status: item.status
      }).then(
        res => {

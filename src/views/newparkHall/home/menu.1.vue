    ...
    <div class="indexMenu">
        ...
        <div class="noticeBox">
            <div class="swiper_com esspclearfix">
                ...
                <div v-if="infoList.length>0">
                    ...
                    ></div>
                    <essp-roll :list="infoList" class="swiper_inner1"/>
                    <div
                        class="swiper_inner2"
        ...
        <div  class="standard-menu">
            <el-carousel height="150px">
                <el-carousel-item v-for="(items,index) in menuListStandard" :key="indexs">
                    <div class="standard-menu-wrap" >
                        <div class="standard-item" v-for="(item,index) in items" :key="index">
                            <img :src="item.url" alt="" @mouseover="imgHover(item)" @mouseleave="imgOut(item)">
                            <div>{{item.name}}</div>
                        </div>
                    </div>
                </el-carousel-item>

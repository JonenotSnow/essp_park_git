        ...
        stepType(){
            if (this.stepType == 3) {
                if (this.firstSetModel == '1') {
                    this.$router.push({path:'/pages/manage/taskPool/setModuleOne',query:{moduleType:1}});
                }else{
                    this.$router.push({path:'/pages/manage/taskPool/setModuleTwo',query:{moduleType:2}});
                }
            }
        }
    },
